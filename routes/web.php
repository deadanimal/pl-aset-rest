...
use App\Http\Controllers\KategoriStorController;
...
use App\Http\Controllers\PembekalAsetController;
...
# umum routes
    ...
    Route::prefix('/kategori-stor')->group(function () {
        ...
        Route::resource('bekalan-am-pejabat', KategoriStorController::class)->names('bap');
        Route::resource('kod-stor-sepusat', KategoriStorController::class)->names('kss');
    });
