        ...
        <form method="POST" action="/kewps7/{{ $kewps7->id }}">
            ...
            <div class="card mt-4">
                <div class="card-header">
                    <div class="row">
                        <div class="col">
                            <h2 class="mb-0">Permohonan Stok (PENYELIA)</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body pt-0">
                    <div class="row">
                        <input class="form-control form-control-sm" type="hidden" name="status" value="DILULUS">
                        <input class="form-control form-control-sm" type="hidden" name="pelulus_id"
                            value="{{ Auth::user()->id }}">
                        <div class="col-4">
                        ...
                        <div class="col-3">
                            ...
                            <div class="input-group">
                                <input class="form-control mb-3" type="text" name="pembungkusan" value="">
                            </div>
                        </div>
                        <div class="col-3">
