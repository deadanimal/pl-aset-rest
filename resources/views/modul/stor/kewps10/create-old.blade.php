@extends('layouts.base_stor') @section('content')
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row" id="aset_create">
                        ...
                        <div class="col-6">
                            ...
                            <select class="form-control mb-3" name="kewps3a_id[]" onchange="nokod(this)">
                                <option selected disabled hidden>Pilih</option>
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                <input class="form-control mb-3" type="text" value="" id="perihal_stok">
                            </div>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-12 mt-4">
                            <h3>Status Stok (A+B+C+D+E+F = Fizikal Stok)</h3>
                        </div>
                        <div class="col-2">
    ...
    <script>
        ...
        function nokod(el) {
            ...
            kewps3a.forEach(element => {
                if (element.id == val) {
                    $("#perihal_stok").val(element.perihal_stok);
                }
            });
        }
