    ...
    <div class="container-fluid mt--6">
        <div class="card mt-4">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="text-end mr-2">
                        <a href="/kewps13/create"><button class="align-self-end btn btn-sm btn-primary"
            ...
            <div class="table-responsive py-4">
                        ...
                        @foreach ($kewps13 as $k13)
                            <tr>
                                ...
                                <td scope="col">
                                    ...
                                    <a href="">
                                        <form action="/kewps13/{{ $k13->id }}" class="d-inline" method="POST">
                                            @method('delete')
                                            @csrf
                ...
                <a class="btn btn-primary ml-3" href="/kewps13pdf">
