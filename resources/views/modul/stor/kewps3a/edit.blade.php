                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="">Kew.ps-3 (A)</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <form method="POST" action="/kewps3a/{{ $kewps3a->id }}">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row mt-5" id="paras_stok_create">
                        ...
                        @foreach ($parasStok as $p)
                            ...
                            <div class="col-3 mt-2">
                                ...
                                <input class="form-control form-control-sm" type="number" name="tahun_paras_stok[]"
                    ...
                    {{-- <a class="btn btn-sm btn-primary text-white mt-2" onclick="tambahParasStok()">Tambah Paras Stok </a> --}}
                    ...
                    <div class="row mt-5" id="terimaan_stok_create">
                        ...
                        @foreach ($terimaan as $t)
                            ...
                            <div class="col-4 mt-2">
                                ...
                                <input class="form-control form-control-sm" type="number" name="tahun_terima_stok[]"
                                    value="{{ $t->tahun_terima_stok }}">
                            </div>
                            <div class="col-4 mt-2">
                                <label for="" class="col-form-label col-form-label-sm">Kuantiti Terima Stok
                                    Pertama</label>
                    ...
                    {{-- <a class="btn btn-sm btn-primary text-white mt-2" onclick="tambahTerimaanStokSuku()">Tambah Stok Suku
                        Tahun</a> --}}
                    <div class="row mt-5" id="keluaran_stok_create">
                        ...
                        @foreach ($keluaran as $k)
                            ...
                            <div class="col-4 mt-2">
                                ...
                                <input class="form-control form-control-sm" type="number" name="tahun_keluar_stok[]"
                                    value="{{ $k->tahun_keluar_stok }}">
                            </div>
                            <div class="col-4 mt-2">
                                <label for="" class="col-form-label col-form-label-sm">Kuantiti Keluar Stok
                                    Pertama</label>
                    ...
                    {{-- <a class="btn btn-sm btn-primary text-white mt-2" onclick="tambahKeluaranStokSuku()">Tambah Keluaran
                        Stok Suku Tahun
                    </a> --}}
                    <div class="mt-5">
