                ...
                @foreach ($kewps1->infokewps1 as $ik1)
                    <div class=" row mt-4 mx-2">
                        ...
                        <div class="col-12">
                            ...
                            <a class="btn btn-danger btn-sm rounded-3" type="submit" onclick="deleteaset()"><span
                        ...
                        <div class="row mx-2 my-3">
                            ...
                            <div class="col-3">
                                ...
                                <select name="unit_pengukuran" class="form-control mb-3">
                                    <option {{ $ik1->unit_pengukuran == 'Unit' ? 'selected' : '' }} value="Unit">Unit
                                    </option>
                                    <option {{ $ik1->unit_pengukuran == 'Kotak' ? 'selected' : '' }} value="Kotak">Kotak
                                    </option>
                                    <option {{ $ik1->unit_pengukuran == 'Rim' ? 'selected' : '' }} value="Rim">Rim
                                    </option>
                                    <option {{ $ik1->unit_pengukuran == 'Butang' ? 'selected' : '' }} value="Butang">
                                        Butang
                                    </option>
                                    <option {{ $ik1->unit_pengukuran == 'Buah' ? 'selected' : '' }} value="Buah">Buah
                                    </option>
                                    <option {{ $ik1->unit_pengukuran == 'Bilah' ? 'selected' : '' }} value="Bilah">Bilah
                                    </option>
                                    <option {{ $ik1->unit_pengukuran == 'Paket' ? 'selected' : '' }} value="Paket">Paket
                                    </option>
                                    <option {{ $ik1->unit_pengukuran == 'Keping' ? 'selected' : '' }} value="Keping">
                                        Keping
                                    </option>
                                </select>
                            </div>
                            <div class="col-3">
                                ...
                                <input class="form-control mb-3" type="number" name="kuantiti_dipesan"
                                    value="{{ $ik1->kuantiti_dipesan }}">
                            </div>
                            <div class="col-3">
                                <label for="">Kuantiti DO</label>
                                <input class="form-control mb-3" type="number" name="kuantiti_do"
                                    value="{{ $ik1->kuantiti_do }}">
                            </div>
                            <div class="col-3">
                                <label for="">Kuantiti Diterima</label>
                                <input class="form-control mb-3" type="number" name="kuantiti_diterima"
                                    value="{{ $ik1->kuantiti_diterima }}">
                            </div>
                            <div class="col-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control" type="number" step="0.01" name="harga_seunit"
                                        value="{{ $ik1->harga_seunit }}">
                                </div>
                            </div>

                            <div class="col-3">
                                <label for="">Catatan</label>
                                <input class="form-control mb-3" type="text" name="catatan" value="{{ $ik1->catatan }}">
                            </div>
            ...
            <form method="POST" action="/info_kewps1">
                ...
                <div class="card mt-4">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                <h2 class="mb-0">Tambah Info kewps1</h2>
                            </div>
                            <div class="text-end mr-2">
