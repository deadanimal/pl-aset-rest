            ...
            <div class="card mt-4" id="basic-info">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-4">
                            <input class="form-control " type="text" name="nama_awal" value="" required>
                        </div>
                        ...
                        <div class="col-4">
                            <input class="form-control" type="text" name="nama_akhir" value="" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-2">
                            <label class="mt-2">Kata Laluan</label>
                        </div>
                        <div class="col-4">
                        ...
                        <div class="col-2">
                            <label class="">Pengesahan Kata Laluan</label>
                        </div>
                        <div class="col-4">
                            <input class="form-control" type="text" name="password_confirmation" value="" required>
                        </div>
                        @error('password')
                            <div class="col-12">
                                <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-4">
                            <input class="form-control" type="date" name="tarikh_mula" value="" required>
                        </div>
                        ...
                        <div class="col-4">
                            <input class="form-control" type="date" name="tarikh_akhir" value="" required>
                        </div>
                    </div>
