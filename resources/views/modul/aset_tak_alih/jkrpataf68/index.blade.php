            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="text-end mr-2">
                        <a href="/jkrpataf68/create"><button class="align-self-end btn btn-sm btn-primary"
                ...
                <table class="table table-custom-simplified table-flush" id="table">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th scope="col">Bilangan Tanah</th>
                    ...
                    <tbody>
                        @foreach ($jkrpataf68 as $ata68)
                            <tr>
                                ...
                                <td scope="col">{{ count($ata68->datatanah) }}</td>

                                <td scope="col">
                                    <a class="btn-sm bg-white border-0" href="/jkrpataf68/{{ $ata68->id }}"><i
