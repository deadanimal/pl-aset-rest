@extends('layouts.base_ata') @section('content')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("input[name=baki_pada_today]").val(j.baki_pada_today);
            $("input[name=anggaran_kos]").val(j.anggaran_kos);
            $("input[name=susut_nilai]").val(j.susut_nilai);
            $("input[name=baki_jangka_hayat]").val(j.baki_jangka_hayat);
