            ...
            <div class="table-responsive py-4">
                <table class="table table-custom-simplified table-flush" id="table">
                    <thead class="thead-light">
                        <tr>
                            <th scope="col">ID</th>
                            <th scope="col">No Rujukan Bil</th>
                    ...
                    <tbody>
                        @foreach ($jkrpataf114 as $p114)
                            <tr>
                                <td scope="col">{{ $p114->id }}</td>
                                <td scope="col">{{ $p114->rujukan_bil }}</td>
                                <td scope="col">{{ $p114->tarikh }}</td>
                                <td scope="col">{{ $p114->bil }}</td>
                                <td scope="col">{{ $p114->no_pendaftaran }}</td>
                                <td scope="col">
