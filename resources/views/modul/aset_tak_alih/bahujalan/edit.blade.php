@extends('layouts.base_ata') @section('content')
                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="">Kemaskini BahuJalan</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-fluid mt--6">
        <form method="POST" action="/bahujalan/{{ $bahujalan->id }}">
            @method('put')
            @csrf
            <div class="card mt-4">
                    ...
                    <div class="row">
                        <div class="col-4 mb-3">
                            ...
                            <select name="jalan_id" class="form-control">
                                @foreach ($jalan as $j)
                                    <option {{ $j->id == $bahujalan->jalan_id ? 'selected' : '' }}
                                        value="{{ $j->id }}">{{ $j->id }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-4 mb-3">
