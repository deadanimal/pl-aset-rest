@extends('layouts.base_pa') @section('content')
    ...
    <div class="container-fluid mt--6">
        <div id="create">
            <form method="POST" action="/info_plpk_pa_0203" enctype="multipart/form-data">
                @csrf
                <div class="card mt-4" id="basic-info">
                    ...
                    <input class="form-control mb-3" type="hidden" name="plpk03_id"
                        value="{{ $plpk_pa_0203->id }}" required>
                </div>
