@extends('layouts.base_pa') @section('content')
    ...
    <div class="container-fluid mt--6">
        <div id="create">
            <form method="POST" action="/plpk_pa_0209" enctype="multipart/form-data">
                @csrf
                <div class="card mt-4" id="basic-info">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                <h2 class="mb-0">Tambah PLPK PA 0209</h2>
                            </div>
                        </div>
                    </div>
                ...
                <div id="info_plpk_pa_0209_create"></div>
        </div>
        </form>
    </div>
    ...
    <script type="text/javascript">
        ...
        function tambahInfo() {
            ...
            $("#info_plpk_pa_0209_create").append(
