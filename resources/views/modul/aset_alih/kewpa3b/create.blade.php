...
<div class="container-fluid mt--6">
    <div id="updateDiv">
        <form id="updateForm" action="/kewpa3b" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="col-4">
                            ...
                            <div class="input-group">
                                <select class="form-control mb-3" name="pegawai_bertanggungjawab" required>
                                    <option value="" selected disabled hidden>Pilih Pegawai</option required>
                        ...
                        <div class="col-4">
                            ...
                            <div class="input-group">
                                <select class="form-control mb-3" name="no_siri_pendaftaran" required>
                                    <option value="" selected disabled hidden>Pilih No Siri Pendaftaran</option required>
