@extends('layouts.base_pa') @section('content')
                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="/info_plpk_pa_0208">info_plpk_pa_0208</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-fluid mt--6">
        <div id="create">
            <form method="POST" action="/info_plpk_pa_0208/{{$info_plpk_pa_0208->id}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card mt-4" id="basic-info">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                <h2 class="mb-0">Sunting Info PLPK PA 0208</h2>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function deleteData(obj) {
            ...
            $.ajax({
                ...
                type: "DELETE",
                success: function() {
                    location.replace = "/info_plpk_pa_0208";;
                }
            })
        }
