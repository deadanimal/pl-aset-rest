          ...
          <tbody>
            ...
            <tr>
              ...
              <td scope="col">
                ...
                <a href="/kewpa2" onclick="deleteData({{$kewpa2}})"><i class="fas fa-trash"></i></a>
              </td>
      ...
      <div class="card mt-4" id="basic-info">
          ...
          <div class="card-body pt-0">
            ...
            <div class="col-4">
              ...
              <div class="input-group">
              <select id="selected_kewpa1" class="form-control mb-3" name="rujukan_kewpa1_id" required>
...
<script type="text/javascript">
    ...
    function updateInfoCreateForm(info_kewpa1) {
      ...
      for (let i=0; i < info_kewpa1.length; i++) {
        option_data = option_data + `<option value=${info_kewpa1[i].id}>No Rujukan INFO KEWPA 1 - ${info_kewpa1[i].id}</option>`
      }
