    ...
    ">
      <div class="row">
        <div class="col text-start">
          <h6 class="text-white">KEWATK 10</h6>
        </div>
    ...
    <div class="card-body pt-0">
      <label for="">Laporan Pemeriksaan Harta</label>
        <div class="input-group">
          ...
          <a id="button_cetak" href="" class="btn btn-sm btn-primary text-white">Cetak Laporan</a>&nbsp;&nbsp;<a id="button_sijil" class="btn btn-sm btn-success text-white">Cetak Sijil</a>
        </div>
