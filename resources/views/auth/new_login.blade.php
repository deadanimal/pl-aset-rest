...
<section style="background-image: url('/assets/img/bg-labuan.jpg') !important;
  ...
  <div class="">
    <div class="row h-100">
      <div class="col-8">
        <div class="row pb-4" style="background: rgba(250,250,250, 0.4); border-bottom-right-radius: 300px;">
          <div class="col-2 d-flex align-items-center">
            <a class="navbar-brand">
              <img src="/assets/img/logo-labuan.png" class="mt-3 ml-3 navbar-brand-img" style="
                max-height: 5rem;">
            </a>
          </div>
