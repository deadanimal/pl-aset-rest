            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="navbar-penerimaan">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="/kewpa1" class="nav-link">
                                        <span class="sidenav-mini-icon"> PA1 </span>
                                        <span class="sidenav-normal"> KEW.PA 1 </span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/kewpa2" class="nav-link">
                                        <span class="sidenav-mini-icon"> PA2 </span>
                                        <span class="sidenav-normal"> KEW.PA 2 </span>
                                    </a>
                                </li>
                            </ul>
                        </div>

                        <a class="nav-link" href="#navbar-pendaftaran" data-toggle="collapse" role="button"
                            aria-expanded="true" aria-controls="navbar-dashboards">

                            <i class="fas fa-book text-primary"></i>
                            <span class="nav-link-text">Pendaftaran</span>
                        </a>
                        <div class="collapse" id="navbar-pendaftaran">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="/kewpa5n6/modal" class="nav-link">
                                        <span class="sidenav-mini-icon"> PA 5 </span>
                                        <span class="sidenav-normal"> KEW.PA 5 </span>
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a href="/kewpa5n6/harta_rendah" class="nav-link">
                                        <span class="sidenav-mini-icon"> PA 56 </span>
                                ...
                                <li class="nav-item">
                                    <a href="/kewpa7" class="nav-link">
                                        ...
                                        <span class="sidenav-normal"> KEW.PA 7 </span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/kewpa8" class="nav-link">
                                        <span class="sidenav-mini-icon"> PA8 </span>
                        ...
                        <a class="nav-link" href="#navbar-pinjaman" data-toggle="collapse" role="button"
                            aria-expanded="true" aria-controls="navbar-dashboards">
                            ...
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="/kewpa12" class="nav-link">
                                        <span class="sidenav-mini-icon"> PA12/13 </span>
                                        <span class="sidenav-normal"> KEW.PA 12/13</span>
                                    </a>
                                </li>
                                {{-- <li class="nav-item">
                        ...
                        <a class="nav-link" href="#navbar-penyelenggaraan" data-toggle="collapse" role="button"
                            aria-expanded="true" aria-controls="navbar-dashboards">
                        ...
                        <div class="collapse" id="navbar-penyelenggaraan">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="/kewpa10" class="nav-link">
                                        <span class="sidenav-mini-icon"> PA10 </span>
                                        <span class="sidenav-normal"> KEW.PA 10 </span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="/plpk_pa_0201" class="nav-link">
                                        <span class="sidenav-mini-icon"> P01</span>
                                        <span class="sidenav-normal">PLPK PA 0201</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/plpk_pa_0202" class="nav-link">
                                        <span class="sidenav-mini-icon"> P02 </span>
                                        <span class="sidenav-normal">PLPK PA 0202</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/plpk_pa_0203" class="nav-link">
                                        <span class="sidenav-mini-icon"> P03</span>
                                        <span class="sidenav-normal">PLPK PA 0203</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/plpk_pa_0204" class="nav-link">
                                        <span class="sidenav-mini-icon"> P04 </span>
                                        <span class="sidenav-normal">PLPK PA 0204</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/plpk_pa_0205" class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="/plpk_pa_0208" class="nav-link">
                                        <span class="sidenav-mini-icon"> P08 </span>
                                        <span class="sidenav-normal">PLPK PA 0208</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/plpk_pa_0209" class="nav-link">
                                        <span class="sidenav-mini-icon"> P09 </span>
                                        <span class="sidenav-normal">PLPK PA 0209</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
