<div class="aligns-item-center bg-transparent" style="padding-top:50%;">
    <div class="text-center" style="width: 100%; height: 100%;margin-top: 50%;">
        <div id="utama" class="bg-transparent cursor-pointer p-2" >
            <div class="" style="background-color: rgba(248,249,254); ">
                <a href="/menu-setting"><span><i style="color: rgba(24,79,121);" class="fas fa-user"></i></span></a>
            </div>
        ...
        <div id="login" class="bg-transparent cursor-pointer">
            <div class="" style="background-color: rgba(248,249,254); ">
                <a href="/logout"><span><i style="color: rgba(24,79,121);" class="fas fa-sign-out-alt"></i></span></a>
            </div>
            <div class="text-center">
                <h5>LOG </br>KELUAR</h5>
            </div>
